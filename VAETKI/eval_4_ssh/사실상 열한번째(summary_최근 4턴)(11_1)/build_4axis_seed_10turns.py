...
# ---------- Axis 1: persona (5 sessions, turns: 10/10/10/10/10) ----------
PERSONA_SESSIONS = [
    s(
...
# ---------- Axis 2: multiturn (5 sessions, turns: 10/10/10/10/10) ----------
MULTITURN_SESSIONS = [
    s(
...
# ---------- Axis 3: foreigner_lang (5 sessions, turns: 10/10/10/10/10) ----------
...
# ---------- Axis 4: recommendation (5 sessions, turns: 10/10/10/10/10) ----------
