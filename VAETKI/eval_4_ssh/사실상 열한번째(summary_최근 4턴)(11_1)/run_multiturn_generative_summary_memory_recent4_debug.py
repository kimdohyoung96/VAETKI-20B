"""Run generative multi-turn dialog with summary memory + recent 4 turns.
...
It replaces full-history accumulation with:
  ...
  3) recent N user-assistant turns only (default: 4)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--recent-turns", type=int, default=4, help="Number of recent user-assistant turns to keep in prompt.")
